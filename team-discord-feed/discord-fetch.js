...
async function fetchChannelMessages(channel, limit = 20) {
    const messages = await channel.messages.fetch({ limit, cache: false, force: true });
...
async function runFetchCycle() {
    ...
    for (const ch of CHANNELS) {
        ...
        try {
            ...
            console.error(`❌ Failed to fetch/write channel ${ch.file}:`, err);
        }
    }
...
// ** THIS PART SHOULD BE OUTSIDE runFetchCycle! **
